        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Thông tin tài liệu</h4>
                </div>
                <div class="card-body p-3 p-sm-4">
                    ...
                    <div class="row mb-3">
                        <label for="type" class="col-lg-2 form-label">Loại thông tin <span class="text-danger">*</span></label>
                        <div class="col-lg-9">
                            <select class="form-select @error('type') is-invalid @enderror" name="type">
                                <option value="">Chọn loại thông tin</option>
                                @foreach ($types as $type)
                                    <option value="{{ $type->id }}" {{ old('type', $result->type ?? null) == $type->id ? 'selected' : '' }}>
                                        {{ $type->name }}
                                    </option>
                                @endforeach
                            </select>
