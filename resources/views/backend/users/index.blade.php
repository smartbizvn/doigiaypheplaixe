...
@section('title_page', 'Quản lý tài khoản')
                        ...
                        <table class="table align-middle nowrap_header_mobile table-bordered table-hover">
                            <thead class="text-muted table-light">
                                <tr class="text-uppercase">
                                    ...
                                    <th class="text-left sortable" width="200">Tên tài khoản</th>
                                    <th class="sort" width='250'>Địa chỉ email</th>
                                    <th class="sort">Vài trò</th>
                                    <th class="text-left" width="200">Mô tả</th>
                                    {{-- Cột chung --}}
