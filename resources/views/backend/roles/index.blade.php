...
@section('title_page', 'Quản lý vai trò')
                        ...
                        <table class="table align-middle nowrap_header_mobile table-bordered table-hover">
                            <thead class="text-muted table-light">
                                <tr class="text-uppercase">
                                    ...
                                    <th class="text-left sortable" width="250">Tên vai trò</th>
                                    <th class="sort">Danh sách quyền</th>
                                    <th class="text-left" width="250">Mô tả</th>
                                    {{-- Cột chung --}}
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if (!empty($result->permissions))
                                                    @foreach($result->permissions as $key => $item)
                                                        <span class="badge badge-soft-secondary badge-border me-1">{{ cutText($item->name,50) }}</span>
                                                    @endforeach
                                                @endif
                                            </td>
                                            <td>
