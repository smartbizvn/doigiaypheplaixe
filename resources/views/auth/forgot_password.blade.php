...
<div class="row justify-content-center">
    <div class="col-md-8 col-lg-6 col-xl-5">
                ...
                <div class="p-2 mt-4">
                    ...
                    <form action="{{ route('postLogin') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name='email' value="{{ old('email', $remember == 'on' ? $email : "") }}" placeholder="Địa chỉ Email">
                            @error('email')
                        ...
                        <div class="mb-3">
                            ...
                            <div class="position-relative auth-pass-inputgroup mb-3">
                                <input type="password" name='password' class="form-control pe-5" value="{{ old('password', $remember == 'on' ? $password : "") }}" placeholder="Mật khẩu" id="password">
                                @error('password')
                                    <p class="error text-danger">
                                        {{ $message }}
                                    </p>
        ...
        {{-- <div class="mt-4 text-center">
            <p class="mb-0"><a href="#" class="fw-semibold text-primary"> Đăng ký tài khoản </a></p>
        </div> --}}
    </div>
</div>
