...
<div class="main-content">
    <div class="rs-breadcrumbs breadcrumbs-overlay">
        <div class="breadcrumbs-img">
            <img src="{{ asset('frontend')}}/assets/images/breadcrumbs/1.jpg" alt="Breadcrumbs Image">
        </div>
    ...
    <div class="rs-inner-blog orange-color pt-100 pb-100 md-pt-70 md-pb-70">
        <div class="container">
            <div class="blog-deatails">
                <div class="bs-img">
                    <a href="#"><img src="{{ asset('frontend')}}/assets/images/blog/inner/1.jpg" alt=""></a>
                </div>
                <div class="blog-full">
                    ...
                    <div class="blog-img mb-40">
                        <img src="{{ asset('frontend')}}/assets/images/blog/inner/2.jpg" alt="">
                    </div>
                    <div class="blog-desc mb-40">
                        <p>
                        ...
                        <div class="content-part">
                            <div class="sec-title">
                                <div class="title-icon md-mb-15">
                                    <img src="{{ asset('frontend')}}/assets/images/newsletter.png" alt="images">
                                </div>
